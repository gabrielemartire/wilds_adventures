class PlanetsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to planets_path, status: :see_other, notice: "Planet was successfully destroyed." }
  ...
  private
    ...
    def planet_params
      params.expect(planet: [ :name, :mission_id, :supply_oxygen, :supply_food, :supply_energy, :radiation, :temperature ])
    end
end
